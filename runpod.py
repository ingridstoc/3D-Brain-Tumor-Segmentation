...
def main():
    ...
    # BraTS often ends up as something like:
    #   /cod_licenta/1/BraTS2021_Training_Data/BraTS2021_Training_Data/<cases...>
    # We'll search for directories containing "*seg*.nii*" somewhere.
